...
func TestJobOrchestratorRun(t *testing.T) {
	...
	orchestrator := NewJobOrchestrator(store, profiles, backend, manager, snippetStore, "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBtestkey agent@test", "http://10.77.0.1:8844", log.New(io.Discard, "", 0))
...
`,
	...
	orchestrator := NewJobOrchestrator(store, profiles, backend, manager, proxmox.SnippetStore{}, "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBtestkey agent@test", "http://10.77.0.1:8844", log.New(io.Discard, "", 0))
...
func TestJobOrchestratorHandleReportComplete(t *testing.T) {
	...
	orchestrator := NewJobOrchestrator(store, profiles, backend, manager, proxmox.SnippetStore{}, "", "http://10.77.0.1:8844", log.New(io.Discard, "", 0))
